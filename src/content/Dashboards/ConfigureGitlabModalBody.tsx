...
import { linkProvider } from '@/utils/auth';
...
export const ConfigureGitlabModalBody: FC<{
  ...
  const handleSubmission = useCallback(async () => {
    ...
    try {
      await linkProvider(token.value, orgId, Integration.GITLAB, {
      ...
      setScopeError(e?.message || 'Unknown error');
      console.error(`Error while linking token:`, e);
    } finally {
      isLoading.false();
    }
  }, [
