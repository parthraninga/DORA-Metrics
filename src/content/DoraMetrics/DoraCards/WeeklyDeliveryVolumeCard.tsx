...
export const WeeklyDeliveryVolumeCard = () => {
  ...
  const hasDeploymentFrequencyStats = useSelector(
    (s) => s.doraMetrics.metrics_summary?.deployment_frequency_stats != null
  );
  const hasDeploymentFrequencySource =
    isCodeProviderIntegrationEnabled || hasDeploymentFrequencyStats;
