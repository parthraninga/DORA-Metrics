...
export const brandColors = {
  pr: {
    ...
    review: '#DCEDC8',
    merge: '#B37EE8',
    firstResponseTime: lighten('#80DEEA', 0.2),
    reworkTime: lighten('#CE93D8', 0.2),
    mergeTime: lighten('#A5D6A7', 0.2),
    time: {
      merge: {
        p90: '#FFC93F',
        avg: '#EEE8AA',
        count: alpha('#80CBC4', 0.35)
      }
    }
  },
  meet: {
...
export const MainTheme = createTheme({
  ...
  palette: {
    ...
    // @ts-ignore
    primaryAlt: createTheme().palette.augmentColor({
      color: {
